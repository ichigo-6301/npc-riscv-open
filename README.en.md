...
| `rv32ima_sv32_linux` | 1.725375105 | 1.894598197 | 1.725944902 | `historical_verified` at `abf66cad`; E1 plus DC compatibility commit `d3caf5fe` awaits an exact-input rerun |
