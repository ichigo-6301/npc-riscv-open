// Headless public wrapper for the frozen RV32IMA/Sv32 Linux source set.
// The profile filelist supplies its ISA/MMU defines; this adapter has no
// dependency on the single-performance wrapper or on board-level RTL.
