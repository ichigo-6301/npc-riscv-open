...
`endif
    ...
    `define ysyx_25050145_Branch_default `BBUS_BR_NONE
    `define ysyx_25050145_Branch_J `BBUS_BR_J
    `define ysyx_25050145_Branch_J_r `BBUS_BR_JR
    `define ysyx_25050145_Branch_E `BBUS_BR_E
    `define ysyx_25050145_Branch_B_eq `BBUS_BR_BEQ
    `define ysyx_25050145_Branch_B_ne `BBUS_BR_BNE
    `define ysyx_25050145_Branch_B_lt `BBUS_BR_BLT
    `define ysyx_25050145_Branch_B_ge `BBUS_BR_BGE
    ...
    `define ysyx_25050145_ALUctr_B_AND_NOT_A 4'b1111
...
`endif
            ...
            casez (instr)
                ...
                32'b???????_?????_?????_011_?????_11100_11: begin // csrrc/csrc
                    RegWr = 1'b1;
                    DatatoReg = `ysyx_25050145_DatatoReg_Csr;
                    ALUBsrc = `ysyx_25050145_ALUBsrc_scsr;
                    ALUctr = `ysyx_25050145_ALUctr_B_AND_NOT_A;
                end
                ...
                32'b0000000_00000_00000_000_00000_11100_11: begin // ecall
                    Branch = `ysyx_25050145_Branch_E;
                end
                32'b0001000_00101_00000_000_00000_11100_11: begin // wfi
                end
                32'b0001001_?????_?????_000_00000_11100_11: begin // sfence.vma
                end
                32'b???????_?????_?????_000_?????_00011_11: begin // fence
                end
                32'b???????_?????_?????_001_?????_00011_11: begin // fence.i
                end
