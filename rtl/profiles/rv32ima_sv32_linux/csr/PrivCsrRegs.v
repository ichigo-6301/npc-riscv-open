...
`ifdef NPC_ASIC
      // DC O-2018 rejects a blocking array-reset loop mixed with normal
      // nonblocking CSR writes. Explicit entries preserve reset priority.
      csr[0] <= {DATA_WIDTH{1'b0}};
      csr[1] <= {DATA_WIDTH{1'b0}};
      csr[2] <= {DATA_WIDTH{1'b0}};
      csr[3] <= {DATA_WIDTH{1'b0}};
      csr[4] <= {DATA_WIDTH{1'b0}};
      csr[5] <= {DATA_WIDTH{1'b0}};
      csr[6] <= {DATA_WIDTH{1'b0}};
      csr[7] <= {DATA_WIDTH{1'b0}};
      csr[8] <= {DATA_WIDTH{1'b0}};
      csr[9] <= {DATA_WIDTH{1'b0}};
      csr[10] <= {DATA_WIDTH{1'b0}};
      csr[11] <= {DATA_WIDTH{1'b0}};
      csr[12] <= {DATA_WIDTH{1'b0}};
      csr[13] <= {DATA_WIDTH{1'b0}};
      csr[14] <= {DATA_WIDTH{1'b0}};
      csr[15] <= {DATA_WIDTH{1'b0}};
      csr[16] <= {DATA_WIDTH{1'b0}};
      csr[17] <= {DATA_WIDTH{1'b0}};
      csr[18] <= {DATA_WIDTH{1'b0}};
      csr[19] <= {DATA_WIDTH{1'b0}};
      csr[20] <= {DATA_WIDTH{1'b0}};
      csr[21] <= {DATA_WIDTH{1'b0}};
      csr[22] <= {DATA_WIDTH{1'b0}};
      csr[23] <= {DATA_WIDTH{1'b0}};
      csr[24] <= {DATA_WIDTH{1'b0}};
      csr[25] <= {DATA_WIDTH{1'b0}};
      csr[26] <= {DATA_WIDTH{1'b0}};
      csr[27] <= {DATA_WIDTH{1'b0}};
      csr[28] <= {DATA_WIDTH{1'b0}};
      csr[29] <= {DATA_WIDTH{1'b0}};
      csr[30] <= {DATA_WIDTH{1'b0}};
      csr[31] <= {DATA_WIDTH{1'b0}};
      csr[32] <= {DATA_WIDTH{1'b0}};
      csr[33] <= {DATA_WIDTH{1'b0}};
      csr[34] <= {DATA_WIDTH{1'b0}};
      csr[35] <= {DATA_WIDTH{1'b0}};
      csr[36] <= {DATA_WIDTH{1'b0}};
      csr[37] <= {DATA_WIDTH{1'b0}};
      csr[38] <= {DATA_WIDTH{1'b0}};
      csr[39] <= {DATA_WIDTH{1'b0}};
      csr[40] <= {DATA_WIDTH{1'b0}};
      csr[41] <= {DATA_WIDTH{1'b0}};
      csr[42] <= {DATA_WIDTH{1'b0}};
      csr[43] <= {DATA_WIDTH{1'b0}};
      csr[44] <= {DATA_WIDTH{1'b0}};
      csr[45] <= {DATA_WIDTH{1'b0}};
      csr[46] <= {DATA_WIDTH{1'b0}};
      csr[47] <= {DATA_WIDTH{1'b0}};
      csr[48] <= {DATA_WIDTH{1'b0}};
      csr[49] <= {DATA_WIDTH{1'b0}};
      csr[50] <= {DATA_WIDTH{1'b0}};
      csr[51] <= {DATA_WIDTH{1'b0}};
      csr[52] <= {DATA_WIDTH{1'b0}};
      csr[53] <= {DATA_WIDTH{1'b0}};
      csr[54] <= {DATA_WIDTH{1'b0}};
      csr[55] <= {DATA_WIDTH{1'b0}};
      csr[56] <= {DATA_WIDTH{1'b0}};
      csr[57] <= {DATA_WIDTH{1'b0}};
      csr[58] <= {DATA_WIDTH{1'b0}};
      csr[59] <= {DATA_WIDTH{1'b0}};
      csr[60] <= {DATA_WIDTH{1'b0}};
      csr[61] <= {DATA_WIDTH{1'b0}};
      csr[62] <= {DATA_WIDTH{1'b0}};
      csr[63] <= {DATA_WIDTH{1'b0}};
      csr[64] <= {DATA_WIDTH{1'b0}};
      csr[65] <= {DATA_WIDTH{1'b0}};
      csr[66] <= {DATA_WIDTH{1'b0}};
      csr[67] <= {DATA_WIDTH{1'b0}};
      csr[68] <= {DATA_WIDTH{1'b0}};
      csr[69] <= {DATA_WIDTH{1'b0}};
      csr[70] <= {DATA_WIDTH{1'b0}};
      csr[71] <= {DATA_WIDTH{1'b0}};
      csr[72] <= {DATA_WIDTH{1'b0}};
      csr[73] <= {DATA_WIDTH{1'b0}};
      csr[74] <= {DATA_WIDTH{1'b0}};
      csr[75] <= {DATA_WIDTH{1'b0}};
      csr[76] <= {DATA_WIDTH{1'b0}};
      csr[77] <= {DATA_WIDTH{1'b0}};
      csr[78] <= {DATA_WIDTH{1'b0}};
      csr[79] <= {DATA_WIDTH{1'b0}};
      csr[80] <= {DATA_WIDTH{1'b0}};
      csr[81] <= {DATA_WIDTH{1'b0}};
      csr[82] <= {DATA_WIDTH{1'b0}};
      csr[83] <= {DATA_WIDTH{1'b0}};
      csr[84] <= {DATA_WIDTH{1'b0}};
      csr[85] <= {DATA_WIDTH{1'b0}};
      csr[86] <= {DATA_WIDTH{1'b0}};
      csr[87] <= {DATA_WIDTH{1'b0}};
      csr[88] <= {DATA_WIDTH{1'b0}};
      csr[89] <= {DATA_WIDTH{1'b0}};
      csr[90] <= {DATA_WIDTH{1'b0}};
      csr[91] <= {DATA_WIDTH{1'b0}};
      csr[92] <= {DATA_WIDTH{1'b0}};
      csr[93] <= {DATA_WIDTH{1'b0}};
      csr[94] <= {DATA_WIDTH{1'b0}};
      csr[95] <= {DATA_WIDTH{1'b0}};
      csr[96] <= {DATA_WIDTH{1'b0}};
      csr[97] <= {DATA_WIDTH{1'b0}};
      csr[98] <= {DATA_WIDTH{1'b0}};
      csr[99] <= {DATA_WIDTH{1'b0}};
      csr[100] <= {DATA_WIDTH{1'b0}};
      csr[101] <= {DATA_WIDTH{1'b0}};
      csr[102] <= {DATA_WIDTH{1'b0}};
      csr[103] <= {DATA_WIDTH{1'b0}};
      csr[104] <= {DATA_WIDTH{1'b0}};
      csr[105] <= {DATA_WIDTH{1'b0}};
      csr[106] <= {DATA_WIDTH{1'b0}};
      csr[107] <= {DATA_WIDTH{1'b0}};
      csr[108] <= {DATA_WIDTH{1'b0}};
      csr[109] <= {DATA_WIDTH{1'b0}};
      csr[110] <= {DATA_WIDTH{1'b0}};
      csr[111] <= {DATA_WIDTH{1'b0}};
      csr[112] <= {DATA_WIDTH{1'b0}};
      csr[113] <= {DATA_WIDTH{1'b0}};
      csr[114] <= {DATA_WIDTH{1'b0}};
      csr[115] <= {DATA_WIDTH{1'b0}};
      csr[116] <= {DATA_WIDTH{1'b0}};
      csr[117] <= {DATA_WIDTH{1'b0}};
      csr[118] <= {DATA_WIDTH{1'b0}};
      csr[119] <= {DATA_WIDTH{1'b0}};
      csr[120] <= {DATA_WIDTH{1'b0}};
      csr[121] <= {DATA_WIDTH{1'b0}};
      csr[122] <= {DATA_WIDTH{1'b0}};
      csr[123] <= {DATA_WIDTH{1'b0}};
      csr[124] <= {DATA_WIDTH{1'b0}};
      csr[125] <= {DATA_WIDTH{1'b0}};
      csr[126] <= {DATA_WIDTH{1'b0}};
      csr[127] <= {DATA_WIDTH{1'b0}};
`else
      integer i;
