...
| `rv32ima_sv32_linux` | RV32IMA M/S + Sv32 五级顺序单发射 | E1 bounded 架构测试待本次同步复核；`abf66cad` CoreMark+difftest仅作历史证据；完整 Linux 未声明 |
...
- [无 SRAM ASIC 实现流程](asic-implementation.md)：DC、OpenROAD/OpenRCX、PrimeTime和证据门禁。
